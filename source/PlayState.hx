...
class PlayState extends MusicBeatState
{
	...
	var ADHDEngineWatermark:FlxText;
	...
	override public function create()
	{
		...
		var rating:Rating = new Rating('bruh');
		rating.ratingMod = 0;
		rating.score = 50;
		rating.noteSplash = false;
		ratingsData.push(rating);
		...
		// Add ADHD Engine watermark
		ADHDEngineWatermark = new FlxText(4, healthBarBG.y + 50, 0, songName + " - " + (storyDifficulty) + " - " + "ADHD-ENGINE", 16);
		ADHDEngineWatermark.setFormat(Paths.font("vcr.ttf"), 16, FlxColor.WHITE, RIGHT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		ADHDEngineWatermark.scrollFactor.set();
		add(ADHDEngineWatermark);
		...
		doof.cameras = [camHUD];
		ADHDEngineWatermark.cameras = [camHUD];
	...
	private function cachePopUpScore()
	{
		...
		Paths.image(pixelShitPart1 + "bruh" + pixelShitPart2);
	...
	function goodNoteHit(note:Note):Void
	{
		if (!note.wasGoodHit)
		{
			...
			if(note.hitCausesMiss) {
				...
				switch(note.noteType) {
					case 'Warning Note': //Warning note
